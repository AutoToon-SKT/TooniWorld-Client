...
class _MyAccountPage3State extends State<MyAccountPage3> {
  ...
  List<Map<String, dynamic>> imageData = [
    {
      'imagePath': 'assets/images/complete4/img0.png',
      'title': 'SKT FLY AI',
      'description':
    ...
    {
      'imagePath': 'assets/images/complete4/img1.png',
      'title': '그랜드 캐니언 탐방기',
      'description':
